...
![CI](https://github.com/dramaorg/occaecati-dolorum/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@dramaorg/occaecati-dolorum.svg?style=flat)](https://www.npmjs.com/package/@dramaorg/occaecati-dolorum)
...
const inject = require('@dramaorg/occaecati-dolorum')
...
```typescript
import * as LightMyRequest from '@dramaorg/occaecati-dolorum'
...
// or
import { inject, DispatchFunc } from '@dramaorg/occaecati-dolorum'
...
- `inject` - standard @dramaorg/occaecati-dolorum `inject` method
- `DispatchFunc` - the fake HTTP dispatch function
- `InjectPayload` - a union type for valid payload types
- `isInjection` - standard @dramaorg/occaecati-dolorum `isInjection` method
- `InjectOptions` - options object for `inject` method
- `Request` - custom @dramaorg/occaecati-dolorum `request` object interface. Extends
...
- `Response` - custom @dramaorg/occaecati-dolorum `response` object interface. Extends Node.js `http.ServerResponse` type
...
- Beware when using the `Request` option. That might make _@dramaorg/occaecati-dolorum_
...
Checks if given object `obj` is a *@dramaorg/occaecati-dolorum* `Request` object.
...
All the credits before the commit [00a2a82](https://github.com/dramaorg/occaecati-dolorum/commit/00a2a82eb773b765003b6085788cc3564cd08326) goes to the `hapi/shot` project [contributors](https://github.com/hapijs/shot/graphs/contributors).
Since the commit [db8bced](https://github.com/dramaorg/occaecati-dolorum/commit/db8bced10b4367731688c8738621d42f39680efc) the project will be maintained by the Fastify team.
